...
public class MyProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strProfileImageURL = getString(R.string.profileImageURL)+auCurrentUsser.getName()+auCurrentUsser.getUserID()+".png";
        //endregion
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String result) {
                        ...
                        if (result.equals("1")) {
                            ...
                            String strImageURL = MyPrefs.getString(getString(R.string.profileImageURL), "not specified");
                            ...
                            auCurrentUsser.setUserProfileImage(bitSelectedImage);
                            auCurrentUsser.setStrProfileImageURL(strProfileImageURL);
