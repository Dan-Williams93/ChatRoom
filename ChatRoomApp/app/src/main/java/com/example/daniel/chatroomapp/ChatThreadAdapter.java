...
import com.example.daniel.chatroomapp.R;
...
public class ChatThreadAdapter extends RecyclerView.Adapter<ChatThreadAdapter.ViewHolder> {
    ...
    //Constructor
    public ChatThreadAdapter(Context context, ArrayList<Message> messages, String userId){
        this.userId = userId;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == SELF) {
            ...
            itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.chat_thread_self, parent, false);
        } else {
